module("June", function(c) { with(c) {
  constructor("InnerJoin", function() {
    ...
    def('subscribe_to_operand', function() {
        ...
        self.right_operand.each(function() {
          ...
          if (self.predicate.evaluate(composite_tuple)) {
            if (extant_composite_tuple) {
              self.tuple_updated(extant_composite_tuple);
            } else {
      ...
      this.right_operand.on_update(function(right_tuple) {
    ...
    def('tuple_updated', function(composite_tuple) {
      this.on_update_node.publish(composite_tuple);
    });
