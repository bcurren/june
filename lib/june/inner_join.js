module("June", function(c) { with(c) {
  constructor("InnerJoin", function() {
    ...
    def('subscribe_to_operand', function() {
      ...
      this.operand_subscriptions.push(this.left_operand.on_update(function(left_tuple) {
      ...
      this.operand_subscriptions.push(this.right_operand.on_update(function(right_tuple) {
