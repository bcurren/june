  ...
  constructor("SetProjection", function() {
    ...
    def('subscribe_to_operand', function() {
      ...
      this.operand.on_remove(function(composite_tuple) {
        var projected_tuple = composite_tuple.tuple_for_set(self.projected_set);
        //(self.operand.find(self.projected_set.id.eq(projected_tuple.id())) != null)
        var operand_contains_another_instance_of_projected_tuple = false;
        self.operand.each(function() {
          if (this.tuple_for_set(self.projected_set) == projected_tuple) operand_contains_another_instance_of_projected_tuple = true;
        })
