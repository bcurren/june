...
//      }
      ...
      if (this.update_notification_enabled && old_value != value) this.set.tuple_updated(this, this.build_changed_attributes_object(attribute, old_value, new_value));
      return new_value;
    });
...
//      this.assign_attributes(attributes);
//      if (this.batch_update_attributes) this.set.tuple_updated(this, changed_attributes);
